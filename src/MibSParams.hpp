...
class MibSParams : public AlpsParameterSet {
 public:
  ...
  enum boolParams{
     ...
     findObjRFGap, // YX: solve another UB problem
     findObjAllRFGaps, // YX: all gap+RF UB problems
     endOfBoolParams
  };
  ...
  enum intParams{
    //     verbosity,
     ...
     useIntegerNoGoodCut,
     useNoGoodCut,
     useGeneralizedNoGoodCut,
     useBendersBinaryCut,
     useBendersInterdictionCut,
     ...
     maxCutDepth,
     setFindObjRF, // YX: set RF type if solve another UB
     endOfIntParams
  };
